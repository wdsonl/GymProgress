...
public class BackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listexercises = findViewById(R.id.listExercisesBack);
        listexercises.setLayoutManager(new LinearLayoutManager(this));

        DBexercises dbexercises = new DBexercises(BackActivity.this);

        listArrayExercises = new ArrayList<>();

        adapter = new ListExercisesAdapter(dbexercises.showExercises("Back"));
